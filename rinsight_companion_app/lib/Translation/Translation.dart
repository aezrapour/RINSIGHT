...
class _TranslationState extends State<Translation> {
  ...
  void _onSpeechResult(SpeechRecognitionResult result) {
    ...
    _debounceTimer = Timer(const Duration(milliseconds: 250), () {
      ...
      translate(getLanguageCode(langRequest), getLanguageCode(langResponse),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 0.5, color: Colors.grey.withOpacity(0.9))),
                    child: DropdownButton(
                      ...
                      items: languages.map((String dropDownLang) {
                        return DropdownMenuItem(
                            value: dropDownLang, child: Text(dropDownLang));
                      }).toList(),
              ...
              Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      translate(
                          getLanguageCode(langRequest),
                          getLanguageCode(langResponse),
